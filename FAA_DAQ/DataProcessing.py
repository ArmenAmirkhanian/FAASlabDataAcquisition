    ...
    with nidaqmx.Task() as strain_task, \
        ...
        try:
            while True:
                ...
                # voltage_data indices 0-11 = displacement, 12-15 = pressure
                strain_vals = [strain_data[i][0]  for i in range(8)]
                disp_vals   = [voltage_data[i][0] for i in range(12)]

                # Process voltage channels (first sample of each channel)
                v17 = voltage_data[12][0]
                v18 = voltage_data[13][0]
                v19 = voltage_data[14][0]
                v20 = voltage_data[15][0]
